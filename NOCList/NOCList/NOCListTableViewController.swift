...
class NOCListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellForRowAtIndexPath", for: indexPath)
    ...
    private func loadNOCList()
    {
        ...
        let jim = (coverName: "Jim Phelps", realName: "Jon Voigt", accessLevel: 9, compromised: false)
