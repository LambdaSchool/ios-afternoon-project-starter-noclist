...
class NOCListTableViewController: UITableViewController
{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = singleAgent.coverName
        cell.detailTextLabel?.text = singleAgent.realName
        
        if singleAgent.compromised {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        destinationVC.agent = agents[selectedIndexPath.row]
