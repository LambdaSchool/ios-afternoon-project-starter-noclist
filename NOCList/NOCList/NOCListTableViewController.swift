...
class NOCListTableViewController: UITableViewController
{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "AgentItemTableViewCell", for: indexPath) as? AgentItemTableViewCell else { return UITableViewCell() }
        
        let anAgent = agents[indexPath.row]
        
        cell.coverNameLabel.text = anAgent.coverName
        cell.realNameLabel.text = anAgent.realName
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let agentDetailViewController = segue.destination as! AgentDetailViewController
        agentDetailViewController.agent = selectedAgent
    }
